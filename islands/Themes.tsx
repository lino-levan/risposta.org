...
export function Themes() {
  const [selectedTheme, setSelectedTheme] = useState<string>("cupcake");
  ...
  return (
    <div class="dropdown">
      ...
      <ul tabIndex={0} class="dropdown-content z-[1] p-2 shadow-2xl bg-base-300 rounded-box w-52 overflow-y-auto max-h-48">
