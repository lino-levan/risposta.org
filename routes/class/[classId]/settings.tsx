...
export default async function Dashboard(
  ...
  return (
    <div class="tabs tabs-boxed bg-base-100" style={{ minWidth: '600px', minHeight: '400px' }}>
      <div class="tabs tabs-boxed bg-white shadow">
        <a href="?tab=classInfo" class={"tab " + (activeTab === "classInfo" ? "tab-active" : "")}>Settings</a>
        <a href="?tab=memberManage" class={"tab " + (activeTab === "memberManage" ? "tab-active" : "")}>Manage Members</a>
      </div>
      ...
      {activeTab === 'memberManage' && (
        <Fragment>
          <h2 class="text-xl pt-4 pb-2 font-bold w-full">Manage Class Members</h2>
          <MemberList classId={ctx.state.class.id} members={membersData}/> {/*Can't get this warning off*/}
        </Fragment>
      )}
    </div>
  );
